...
export default function RotateInviteButton({ groupId }: Props) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg shadow-lg w-full max-w-sm p-6 space-y-4">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400">
              This generates a new invite link. The old link will stop working immediately — anyone
              you have already shared it with will need the new one.
            </p>
